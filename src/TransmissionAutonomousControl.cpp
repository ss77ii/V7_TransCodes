...
void auton_60s_skills_bridge_version()
{
	...
	goStraightCm_Front_Vision(60, 80, 100, DETECT_YELLOW_GOAL_SIG, front_vision, 0.5, 0, 1, 0.3, 0, 10, 0.8, 0, 0, 1500, 1, hardwareParameter);
	...
	goStraightCm_Back_Vision(distance + 20, 350, 65, DETECT_BLUE_GOAL_SIG, back_vision, 0.5, 0, 1, 0.5, 0, 5, 0.5, 0, 5, 800, 1, hardwareParameter);
